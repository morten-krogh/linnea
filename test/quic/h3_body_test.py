...
body = b"linnea echoes this request body back over http/3"
enc = pylsqpack.Encoder()
enc.apply_settings(max_table_capacity=0, blocked_streams=0)
_, fields = enc.encode(0, [(b":method", b"POST"), (b":path", b"/submit"),
                           (b":scheme", b"https"), (b":authority", b"h3.test")])
# a HEADERS frame followed by a DATA frame carrying the body
...
assert data == body, f"echoed {data!r}, sent {body!r}"
print("ok")
