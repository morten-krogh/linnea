...
| `cache_control` | string | none | ≤ 255 | `Cache-Control` value for responses owned by a static location, including conditional and error responses. Only meaningful with `root`. Must be a valid HTTP field value — see below. |
